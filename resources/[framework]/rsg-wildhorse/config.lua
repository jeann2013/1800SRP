...
Config.Blip =
{
    blipName = Lang:t('menu.sell_wild_horse_menu'),
...
{
    {name = 'Valentine '..Lang:t('menu.horse_seller_menu'),      location = 'valentine-sellwildhorse',     coords = vector3(-382.54, 788.06, 115.91 -0.8), showblip = true }, --valentine
    {name = 'St Denis '..Lang:t('menu.horse_seller_menu'),       location = 'stdenis-sellwildhorse',       coords = vector3(2839.5, -1305.68, 46.66 -0.8), showblip = true }, --stdenis
    {name = 'West Elizabeth '..Lang:t('menu.horse_seller_menu'), location = 'westelizabeth-sellwildhorse', coords = vector3(-2543.44, 401.73, 148.28 -0.8), showblip = true }, --westelizabeth
    {name = 'Stawberry '..Lang:t('menu.horse_seller_menu'),      location = 'stawberry-sellwildhorse',     coords = vector3(-3641.46, -2626.49, -13.73 -0.8), showblip = true }, --stawberry
    {name = 'Tumbleweed '..Lang:t('menu.horse_seller_menu'),     location = 'tumbleweed-sellwildhorse',    coords = vector3(-5527.8, -2948.04, -1.56 -0.8), showblip = true }, --tumbleweed
    {name = 'Blackwater '..Lang:t('menu.horse_seller_menu'),     location = 'blackwater-sellwildhorse',    coords = vector3(-945.21, -1337.29, 50.65 -0.8), showblip = true }, --blackwater
    {name = 'Rhodes '..Lang:t('menu.horse_seller_menu'),         location = 'rhodes-sellwildhorse',        coords = vector3(1434.89, -1291.61, 77.82 -0.8), showblip = true }, --blackwater
    {name = 'Van Horn '..Lang:t('menu.horse_seller_menu'),       location = 'vanhorn-sellwildhorse',       coords = vector3(2932.95, 568.53, 44.99 -0.8), showblip = true }, --blackwater
}
