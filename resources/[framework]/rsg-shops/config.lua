...
Config.Products = {
    ["normal"] = {
        [1] =  { name = "water",                             price = 0.3, amount = 500, info = {}, type = "item", slot = 1 },
        [2] =  { name = "bread",                             price = 0.3, amount = 500, info = {}, type = "item", slot = 2 },
        -- [3] =  { name = "fieldbandage",                      price = 1.00, amount = 500, info = {}, type = "item", slot = 3 },
        [4] =  { name = "horsebrush",                        price = 0.25,   amount = 100, info = {}, type = "item", slot = 4 },
        [5] =  { name = "horselantern",                      price = 1,   amount = 100, info = {}, type = "item", slot = 5 },
        [6] =  { name = "goldpan",                           price = 0.76,   amount = 100, info = {}, type = "item", slot = 6 },
        [7] =  { name = "goldsmelt",                         price = 50,   amount = 100, info = {}, type = "item", slot = 7 },
        [8] =  { name = "campfire",                          price = 1,   amount = 100, info = {}, type = "item", slot = 8 },
        [9] =  { name = "shovel",                            price = 1.20,    amount = 100, info = {}, type = "item", slot = 9 },
        [10] = { name = "axe",                               price = 1.45,    amount = 100, info = {}, type = "item", slot = 10 },
        [11] = { name = "pickaxe",                           price = 1.41,    amount = 100, info = {}, type = "item", slot = 11 },
    ...
    ["weapons"] = {
        -- WEAPONS REVOLVER
        [1] = { name = "weapon_revolver_cattleman",            price = 28.99,  amount = 50,   info = {}, type = "weapon", slot = 1, },
        [2] = { name = "weapon_revolver_cattleman_mexican",    price = 43.99, amount = 50,   info = {}, type = "weapon", slot = 2, },
        -- [3] = { name = "weapon_revolver_doubleaction_gambler", price = 56.86, amount = 50,   info = {}, type = "weapon", slot = 3, },
        [3] = { name = "weapon_revolver_schofield",            price = 38.79, amount = 50,   info = {}, type = "weapon", slot = 3, },
        ...
        -- [7] = { name = "weapon_revolver_lemat",                price = 62.32, amount = 50,   info = {}, type = "weapon", slot = 7, },
        -- -- WEAPONS PISTOL
        ...
        -- -- WEAPONS RIFLE
        -- [11] = { name = "weapon_rifle_varmint",                price = 65.33,  amount = 50,   info = {}, type = "weapon", slot = 11, },
        -- [12] = { name = "weapon_rifle_springfield",            price = 91.33, amount = 50,   info = {}, type = "weapon", slot = 12, },
        -- [13] = { name = "weapon_rifle_boltaction",             price = 88.99, amount = 50,   info = {}, type = "weapon", slot = 13, },
        -- [14] = { name = "weapon_sniperrifle_rollingblock",     price = 411, amount = 50,   info = {}, type = "weapon", slot = 14, },
        -- -- WEAPONS REPEATER
        -- [15] = { name = "weapon_repeater_carbine",             price = 59.39,  amount = 50,   info = {}, type = "weapon", slot = 15, },
        -- [16] = { name = "weapon_repeater_evans",               price = 65.21, amount = 50,   info = {}, type = "weapon", slot = 16, },
        -- [17] = { name = "weapon_repeater_winchester",          price = 74.87, amount = 50,   info = {}, type = "weapon", slot = 17, },
        -- [18] = { name = "weapon_repeater_henry",               price = 68.79, amount = 50,   info = {}, type = "weapon", slot = 18, },
        -- [19] = { name = "weapon_rifle_elephant",               price = 89.33, amount = 50,   info = {}, type = "weapon", slot = 19, },
        -- -- WEAPONS SHOTGUN
        -- [20] = { name = "weapon_shotgun_sawedoff",             price = 53.40, amount = 50,   info = {}, type = "weapon", slot = 20, },
        ...
        -- -- WEAPONS OTHER
        [11] = { name = "weapon_melee_knife",                  price = 2.80,  amount = 50,   info = {}, type = "weapon", slot = 11, },
        [12] = { name = "weapon_lasso",                        price = 1.99,   amount = 50,   info = {}, type = "weapon", slot = 12, },
        ...
        [15] = { name = "weapon_lasso_reinforced",             price = 500,  amount = 50,   info = {}, type = "weapon", slot = 15, },
        [16] = { name = "weapon_melee_machete",                price = 8.33,  amount = 50,   info = {}, type = "weapon", slot = 16, },
        [17] = { name = "weapon_melee_hatchet",                price = 1.50,  amount = 50,   info = {}, type = "weapon", slot = 17, },
        
        
        
        -- AMMO
        [4] = { name = "ammo_revolver",                       price = 0.99, amount = 500, info = {}, type = "item",   slot = 4, },
        [5] = { name = "ammo_pistol",                         price = 0.50, amount = 500, info = {}, type = "item",   slot = 5, },
        [6] = { name = "ammo_rifle",                          price = 1.99, amount = 500, info = {}, type = "item",   slot = 6, },
        ...
        [9] = { name = "ammo_shotgun",                        price = 1.69, amount = 500, info = {}, type = "item",   slot = 9, },
