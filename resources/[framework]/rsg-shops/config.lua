...
Config.Products = {
    ...
    ["weapons"] = {
        ...
        [3] = { name = "weapon_revolver_schofield",            price = 192, amount = 50,   info = {}, type = "weapon", slot = 3, },
        ...
        [6] = { name = "ammo_rifle",                          price = 0.75, amount = 500, info = {}, type = "item",   slot = 6, },
        [7] = { name = "ammo_varmint",                        price = 0.75, amount = 500, info = {}, type = "item",   slot = 7, },
        -- [31] = { name = "ammo_rifle_elephant",                 price = 0.75, amount = 500, info = {}, type = "item",   slot = 31, },
        [8] = { name = "ammo_repeater",                       price = 0.75, amount = 500, info = {}, type = "item",   slot = 8, },
        [9] = { name = "ammo_shotgun",                        price = 0.75, amount = 500, info = {}, type = "item",   slot = 9, },
