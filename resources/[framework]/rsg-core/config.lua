...
RSGConfig.MaxPlayers = GetConvarInt('sv_maxclients', 64) -- Gets max players from config file, default 48
...
RSGConfig.Money = {}
RSGConfig.Money.MoneyTypes = { cash = 100, bank = 0, bloodmoney = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
...
RSGConfig.Player.HungerRate = 0 -- Rate at which hunger goes down.
RSGConfig.Player.ThirstRate = 0 -- Rate at which thirst goes down.
