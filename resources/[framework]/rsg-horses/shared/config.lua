...
-- horse shop
Config.HorseShop = {
    [1] = { name = "horsebrush",   price = 3,    amount = 500,  info = {}, type = "item", slot = 1, },
    [2] = { name = "horselantern", price = 7,   amount = 500,  info = {}, type = "item", slot = 2, },
    [3] = { name = "horseholster", price = 3,    amount = 500,  info = {}, type = "item", slot = 3, },
